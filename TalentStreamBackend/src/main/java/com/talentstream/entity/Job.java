...
public class Job {
   ...
   @Column(nullable = false)
    ...
    private List<RecuriterSkills> skillsRequired;
...
public int getMaximumExperience() {
	...
	public List<RecuriterSkills> getSkillsRequired() {
		return skillsRequired;
	}

	public void setSkillsRequired(List<RecuriterSkills> skillsRequired) {
